...
/**
 * This is the item provider adapter for a {@link it.polimi.isgroup.secbpmn2bc.model.DataItems} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataItemsItemProvider extends it.unitn.disi.sweng.secbpmn.model.edit.provider.DataItemsItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DataItemsItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DataItems")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((DataItems) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_DataItems_type") : //$NON-NLS-1$
				getString("_UI_DataItems_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataItems.class)) {
