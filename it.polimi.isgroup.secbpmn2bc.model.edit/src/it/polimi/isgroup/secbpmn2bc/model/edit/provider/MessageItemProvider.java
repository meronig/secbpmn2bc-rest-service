...
/**
 * This is the item provider adapter for a {@link it.polimi.isgroup.secbpmn2bc.model.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider extends DataItemsItemProvider {
	/**
	...
	protected void addReferencesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Message_references_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Message_references_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Message_type"), //$NON-NLS-1$
						SecBPMNPackage.Literals.MESSAGE__REFERENCES, true, false, true, null, null, null));
	}
