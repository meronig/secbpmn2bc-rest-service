...
/**
 * This is the item provider adapter for a {@link it.polimi.isgroup.secbpmn2bc.model.PrivitySphere} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrivitySphereItemProvider extends SecurityAnnotationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PrivitySphereItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addScopePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PrivitySphere_Scope_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_PrivitySphere_Scope_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_PrivitySphere_type"), //$NON-NLS-1$
						SecBPMN2BCPackage.Literals.PRIVITY_SPHERE__SCOPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns PrivitySphere.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PrivitySphere")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((PrivitySphere) object).getUuid();
		return label == null || label.length() == 0 ? getString("_UI_PrivitySphere_type") : //$NON-NLS-1$
				getString("_UI_PrivitySphere_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrivitySphere.class)) {
