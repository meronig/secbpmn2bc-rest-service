...
public interface SecBPMN2BCFactory extends EFactory {
	...
	/**
	 * Returns an instance of data type '<em>Boolean With Null</em>' corresponding the given literal.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param literal a literal of the data type.
	 * @return a new instance value of the data type.
	 * @generated
	 */
	Boolean createBooleanWithNull(String literal);

	/**
	 * Returns a literal representation of an instance of data type '<em>Boolean With Null</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param instanceValue an instance value of the data type.
	 * @return a literal representation of the instance value.
	 * @generated
	 */
	String convertBooleanWithNull(Boolean instanceValue);
