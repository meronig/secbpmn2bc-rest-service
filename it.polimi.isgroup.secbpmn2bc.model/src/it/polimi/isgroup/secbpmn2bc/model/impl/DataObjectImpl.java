 ...
 * </p>
 * <ul>
 *   <li>{@link it.polimi.isgroup.secbpmn2bc.model.impl.DataObjectImpl#getOnChainData <em>On Chain Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataObjectImpl extends it.unitn.disi.sweng.secbpmn.model.impl.DataObjectImpl implements DataObject {
	/**
	...
	protected EClass eStaticClass() {
		return SecBPMN2BCPackage.Literals.DATA_OBJECT;
	}
	...
	public void setOnChainData(OnChainData newOnChainData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecBPMN2BCPackage.DATA_OBJECT__ON_CHAIN_DATA,
	...
	public void unsetOnChainData() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SecBPMN2BCPackage.DATA_OBJECT__ON_CHAIN_DATA,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SecBPMN2BCPackage.DATA_OBJECT__ON_CHAIN_DATA:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DataItems.class) {
			...
			case SecBPMN2BCPackage.DATA_ITEMS__ON_CHAIN_DATA:
				return SecBPMN2BCPackage.DATA_OBJECT__ON_CHAIN_DATA;
			default:
				return -1;
			}
		}
