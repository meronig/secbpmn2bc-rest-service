 ...
 * </p>
 * <ul>
 *   <li>{@link it.polimi.isgroup.secbpmn2bc.model.impl.MessageRefImpl#getOnChainData <em>On Chain Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MessageRefImpl extends it.unitn.disi.sweng.secbpmn.model.impl.MessageRefImpl implements MessageRef {
	...
	protected EClass eStaticClass() {
		return SecBPMN2BCPackage.Literals.MESSAGE_REF;
	}
	...
	public void setOnChainData(OnChainData newOnChainData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecBPMN2BCPackage.MESSAGE_REF__ON_CHAIN_DATA,
	...
	public void unsetOnChainData() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SecBPMN2BCPackage.MESSAGE_REF__ON_CHAIN_DATA,
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DataItems.class) {
			...
			case SecBPMN2BCPackage.DATA_ITEMS__ON_CHAIN_DATA:
				return SecBPMN2BCPackage.MESSAGE_REF__ON_CHAIN_DATA;
			default:
				return -1;
			}
		}
