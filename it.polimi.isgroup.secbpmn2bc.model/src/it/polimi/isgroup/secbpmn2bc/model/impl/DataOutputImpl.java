 ...
 * </p>
 * <ul>
 *   <li>{@link it.polimi.isgroup.secbpmn2bc.model.impl.DataOutputImpl#getOnChainData <em>On Chain Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataOutputImpl extends it.unitn.disi.sweng.secbpmn.model.impl.DataOutputImpl implements DataOutput {
	/**
	...
	protected EClass eStaticClass() {
		return SecBPMN2BCPackage.Literals.DATA_OUTPUT;
	}
	...
	public void setOnChainData(OnChainData newOnChainData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecBPMN2BCPackage.DATA_OUTPUT__ON_CHAIN_DATA,
	...
	public void unsetOnChainData() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SecBPMN2BCPackage.DATA_OUTPUT__ON_CHAIN_DATA,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SecBPMN2BCPackage.DATA_OUTPUT__ON_CHAIN_DATA:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DataItems.class) {
			...
			case SecBPMN2BCPackage.DATA_ITEMS__ON_CHAIN_DATA:
				return SecBPMN2BCPackage.DATA_OUTPUT__ON_CHAIN_DATA;
			default:
				return -1;
			}
		}
